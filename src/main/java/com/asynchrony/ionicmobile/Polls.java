...
//
//    %h3 Curl Example
//    - request_params = { poll: { title: 'name of poll' }}
//    - simple = authenticated_curl_example polls_url(format: :json), request_params, 'POST'
//            - extended = authenticated_resty_example polls_path(format: :json), request_params, 'POST'
//            = render 'authenticated_examples', simple: simple, extended: extended, id: 'Polls-create'
//
...
//
//    %h3 Curl Example
//    - simple = authenticated_curl_example poll_url(1, format: :json)
//    - extended = authenticated_resty_example poll_path(1, format: :json)
//    = render 'authenticated_examples', simple: simple, extended: extended, id: 'Polls-show'
//
//            %h3 Successful Response
//    %p
//    %pre
